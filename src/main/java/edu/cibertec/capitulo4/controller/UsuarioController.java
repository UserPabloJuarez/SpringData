...
public class UsuarioController {
    ...
    public ModelAndView usuarioGrabar(@RequestParam("archivo") CommonsMultipartFile foto,
            @Valid @ModelAttribute("usuarioBean") UsuarioEntity usuarioValida, BindingResult result, ModelMap modelMap,
            HttpSession session) {
